<div class="relative overflow-x-auto bg-white p-4 shadow-md sm:rounded-lg">
    ...
    <div class="pb-4 bg-white flex justify-between">
        ...
        <div class="relative mt-1">
            ...
            <input wire:model.live="search" type="text" placeholder="Buscar..."  id="table-search" class="block pt-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search for items">
        </div>
...
<a
    ...
    wire:navigate
    class="bg-blue-600 hover:bg-blue-800 focus:ring-blue-300 text-white rounded-lg px-4 py-2">
        ...
        @forelse ($items as $index => $item)
            ...
            <td class="px-6 py-4 flex gap-2 justify-end {{ $index === count($items) - 1 ? 'rounded-br-xl' : '' }}">
                    <a
                        ...
                        wire:navigate.hover
                        class="bg-yellow-600 hover:bg-yellow-800 focus:ring-green-300 text-white rounded-lg px-4 py-2">
                    ...
                    <button wire:confirm="¿Estás seguro de que deseas eliminar este registro?" wire:click="delete({{ $item->id }})" class="bg-red-600 hover:bg-red-800 focus:ring-red-300 text-white rounded-lg px-4 py-2">
